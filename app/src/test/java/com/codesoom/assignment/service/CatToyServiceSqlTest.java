...
public class CatToyServiceTempTest {
    @Autowired
    ...
    class Describe_create {
        ...
        class Context_with_catToy {
            ...
            void It_returns_catToyAndSave() {
                CatToy catToy = toyService.create(new ToyInfo("이름", "메이커", 3000, "url"));

                assertThat(catToy).isEqualTo(
                        new CatToy(1L, "이름", "메이커", 3000, "url"));
            }
        }
    }
    @Nested
    ...
    class Describe_findById {
        ...
        class Context_with_toyWithId {
            ...
            void It_returns_toy() {
                ...
                assertThat(toyService.findById(1L))
                        .isEqualTo(new CatToy(1L, "이름", "메이커", 3000, "url"));
            }
        }
        ...
        class Context_without_toy {
            ...
            void It_throws_exception() {
                assertThatThrownBy(() -> toyService.findById(1L))
    ...
    class Describe_findAll {
        ...
        class Context_with_toyList {
            @BeforeEach
            void prepare() {
                toyService.create(new ToyInfo("이름", "메이커", 3000, "url"));
                toyService.create(new ToyInfo("이름", "메이커", 3000, "url"));
            }
